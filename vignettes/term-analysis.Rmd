...
# extract unigrams
processed_terms <- bigrams_by_date(textData = covid19topics::covid19preprints, 
                                    textColumn = "title", 
                                    dateColumn = "pub_date")

termfreqs <- term_frequencies(processed_terms, timeBinUnit = "month")

topterms <- select_top_terms(termfreqs)

termfreqs <- dplyr::arrange(termfreqs, term_share_per_timebin)
